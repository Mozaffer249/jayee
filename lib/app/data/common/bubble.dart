...
//        assert(radius <= nipHeight + nipOffset),
    ...
    _nipCX = _nipCX! - nipStickOffset;
    _nipCY = nipRadius!;
    _nipPX = _nipCX! - nipRadius! * sin(a);
    _nipPY = _nipCY! + nipRadius! * cos(a);
    _startOffset = _startOffset! - nipStickOffset;
    _endOffset = _endOffset! - nipStickOffset;
  ...
  Bubble({
    ...
    BubbleStyle? style,
        ...
        bubbleClipper = BubbleClipper(
          radius: radius ?? style?.radius ?? const Radius.circular(6.0),
...
class BubblePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (elevation != 0.0) {
      canvas.drawShadow(
          clipper!.getClip(size), shadowColor!, elevation!, false);
    }
